...
writer = SummaryWriter(f'log_{args.log_num}/PennyLane_{args.task}_Quantum_DQN')
...
path = f'/scratch/connectome/justin/log_{args.log_num}/PennyLane_{args.task}_Quantum_DQN_{args.log_num}.pth'
...
path = f'/scratch/connectome/justin/log_{args.log_num}/PennyLane_{args.task}_Quantum_DQN_{args.log_num}.hdf5'
...
buffer_res.to_csv(f'/scratch/connectome/justin/log_{args.log_num}/PennyLane_{args.task}_Quantum_DQN_{args.log_num}.csv')
...
df = df.transpose()
df.to_csv(f'/scratch/connectome/justin/log_{args.log_num}/PennyLane_{args.task}_Quantum_DQN_entropy_{args.log_num}.csv')
